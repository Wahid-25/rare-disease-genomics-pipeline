...
.. raw:: html
   ...
   <section class="genosphere-cover">
     ...
     <p class="cover-subtitle">A reproducible GRCh38 workflow for rare-disease prioritisation, CNV analysis, repeat-expansion routing, inheritance modelling, selected pharmacogenomic interpretation and structured report preparation.</p>
     <div class="cover-actions">
       ...
       <a class="report-cover-button" href="report_builder/index.html" target="_blank" rel="noopener">Open report builder</a>
     </div>
   </section>
...
It integrates small-variant annotation, copy-number analysis, repeat-expansion reporting, gene–disease mapping, HPO phenotype evidence, inheritance and ploidy modelling, compound-heterozygous assessment, exact allele-aware pharmacogenomic matching and a final clinical-style reporting stage.
...
.. raw:: html
   ...
   <div class="feature-grid">
     ...
     <div class="feature-card"><h3>Automatic report drafting</h3><p>Creates a structured JSON draft, verifies its checksum and loads it into the local report builder for analyst review.</p></div>
   </div>
...
The pages below contain the complete updated 21-section manual, including clinical-style report preparation, automatic JSON report population and the final project conclusion.
...
.. toctree::
   :maxdepth: 3
   :caption: Clinical reporting, automation and conclusion

   19_clinical_report
   20_automatic_report_json
   21_conclusion
   glossary
   references
...
.. warning::
   ...
   The workflow produces computational candidate-prioritisation results. It does not independently establish a diagnosis, confirm a variant or recommend a medication change. Real genomic and phenotype data must remain protected and must not be entered into the publicly hosted report-builder demonstration.
