...
.. raw:: html
   ...
   <div class="feature-grid">
     ...
     <div class="feature-card"><h3>Clinical-style report</h3><p>Guides the analyst from reviewed output evidence to a structured, quality-controlled report.</p></div>
   </div>
...
The pages below contain the complete updated 20-section manual, ending with clinical-style report preparation and the final project conclusion.
...
.. toctree::
   :maxdepth: 3
   :caption: Clinical reporting and conclusion
